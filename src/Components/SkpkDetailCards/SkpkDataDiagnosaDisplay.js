...
const SkpkDataDiagnosaDisplay = (props) => {
  const { diagnosaSkpkList } = props;
  const lamaKematian = Object.keys(diagnosaSkpkList).length === 8 ? 0 : 1;
...
export default SkpkDataDiagnosaDisplay;